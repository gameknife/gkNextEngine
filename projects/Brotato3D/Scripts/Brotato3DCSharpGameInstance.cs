...
public sealed partial class Brotato3DCSharpGameInstance : NextGameInstance
{
    ...
    // Not project content, unlike the configs: the SFX ship inside assets/paks/brotato3d.pak, whose
    // entry names are fixed at assets/sounds/brotato3d/sfx/ (tools/brotato3d-pak), and the C++
    // Brotato3D plays the same files.
